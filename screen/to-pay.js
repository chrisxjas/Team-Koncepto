      ...
      <View style={styles.orderCard}>
        ...
        <View style={styles.orderTotalContainer}>
          <Text style={styles.orderTotalText}>
            Total: ₱ {parsePrice(item.total_price).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </Text>
        </View>
      </View>
    );
...
const styles = StyleSheet.create({
  ...
  tabButton: { marginRight: 15, paddingVertical: 6 },
  activeTabButton: {},
  tabInner: { flexDirection: 'row', alignItems: 'center' },
  tabText: { fontSize: 14, color: colors.textSecondary, fontWeight: '500' },
  activeTabText: { fontWeight: 'bold', color: colors.primaryGreen, borderBottomWidth: 2, borderBottomColor: colors.primaryGreen, paddingBottom: 2 },
  ...
  viewButton: { backgroundColor: colors.primaryGreen, paddingVertical: 6, paddingHorizontal: 12, borderRadius: 5, alignSelf: 'flex-end' },
